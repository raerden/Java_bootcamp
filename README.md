...
2. [Chapter II](AP1_Jv_T02/)
    - [Проект: Pet Info](AP1_Jv_T01/)
    - [Задание 1. Список питомцев](AP1_Jv_T01/exercise0)
    - [Задание 2. Определение количества корма питомцу](AP1_Jv_T01/exercise1)
    - [Задание 3. Списки травоядных и всеядных питомцев](AP1_Jv_T01/exercise2)
    - [Задание 4. Увеличение возраста конкретных питомцев в функциональной парадигме](AP1_Jv_T01/exercise3)
    - [Задание 5. Отслеживание прогулок питомцев](AP1_Jv_T01/exercise4)
    - [Задание 6. Итератор питомцев](AP1_Jv_T01/exercise5)
