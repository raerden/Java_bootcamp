...
public class Main {
    public static void main(String[] args) {
       ...
       //Функциональная парадигма: не изменяем обьект, а создаем новый
       List<Animal> petsAged = pets.stream()
            .map(Animal::copyWithIncrementedAge)
            .toList();

        petsAged.forEach(System.out::println);
    }
